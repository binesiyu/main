...
require("packer").startup(function(use)
    ...
    -- Icons
    useAndRequire(use,{"kyazdani42/nvim-web-devicons", opt = true},"nvim-web-devicons")
...
map('<C-P>',':Telescope find_files<cr>','n',noremap_cfg)
map('<leader>ff',':Telescope find_files<cr>','n',noremap_cfg)
map('<leader>fg',':Telescope live_grep<cr>','n',noremap_cfg)
map('<leader>fb',':Telescope buffers<cr>','n',noremap_cfg)
map('<leader>fh',':Telescope help_tags<cr>','n',noremap_cfg)
